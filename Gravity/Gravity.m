...
d_calc=Jac_Z*dens_const';

%% find indices along seismic section

load('C:\Users\22649517\Desktop\Data\Yamarna_ROI\Section_of_Int\cdp_coor.mat','cdp_x','cdp_y');
load('C:\Users\\Model_f.mat','Model_f');
load('C:\Users\\dens_const_prior10.mat','dens_const_prior10')
model_3d = Model_f;
d_size_mesh = 500;
s=300; % cdp sampling
nx =180;ny=80;nz=20;
...
z_min = 0.000000;
z_max = 10000;
[Model_2d_f,Model_2d,nlset,X_ind,Y_ind,Z_ind] = Mod_dim_convertor(d_size_mesh,nx,ny,nz, x_min, x_max,y_min,y_max,z_min,z_max,...
    model_3d,dens_const_prior10,s,cdp_x,cdp_y);
